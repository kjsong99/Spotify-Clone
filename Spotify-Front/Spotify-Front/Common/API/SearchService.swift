...
final class SearchService {
    ...
    func album(keyword: String, completion: @escaping (Result<[Search], Error>) -> Void) {
        provider.request(.album(keyword: keyword)) { result in
    ...
    func music(keyword: String, completion: @escaping (Result<[Search], Error>) -> Void) {
        provider.request(.music(keyword: keyword)) { result in
    ...
    func artist(keyword: String, completion: @escaping (Result<[Search], Error>) -> Void) {
        provider.request(.artist(keyword: keyword)) { result in
